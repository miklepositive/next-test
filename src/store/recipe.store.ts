...
export const useRecipeStore = create<IRecipeState>(set => ({
    ...
    addRecipe: async (formData: FormData) => {
        ...
        try {
            ...
            console.log('error', error);
            set({ error: 'Error while adding recipe', isLoading: false });
            return { success: false, error: 'Error while adding recipe' };
        }
    },
    updateRecipe: async (id: string, formData: FormData) => {
        ...
        try {
            ...
            console.log('error', error);
            set({ error: 'Error while updating ingredient', isLoading: false });
            return { success: false, error: 'Error while updating ingredient' };
        }
    },
    removeRecipe: async (id: string) => {
        ...
        try {
            ...
            console.log('error', error);
            set({ error: 'Error while removing recipe', isLoading: false });
        }
    },
